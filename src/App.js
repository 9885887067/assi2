...
class App extends Component{ 
  ...
  addContent=event=>{
    ...
    const classValue=colourList[Marh.floor(Math.random()*5)]
...
deleteItem=id=>{
  ...
  this.setState({
    latestList:newList,isTrue:caseOf
  })
}
  ...
  render(){
    ...
    const newList=latestList.filter(value=>value.webSite.toLowerCase().includes(searchInput.toLowerCase()),)
  ...
  <div className="app-container">
      ...
      <div className="password-card-container">
        <form className="add-new-password" onSubmit={this.addContent}>
          ...
          <div className="input-container">
            ...
            />
            <input type="text" className="input" placeholder="Enter Website" onChange={this.listenWebsite} value={website}/>
          </div>
          ...
          <div className="input-container">
            <img
              ...
              className="input-image"
            />
            <input type="text" className="input" placeholder="Enter Username" onChange={this.listenUsername} value={username}/>
          </div>
          ...
          <div className="input-container">
            ...
            <input
              ...
              onChange={this.listenPassword} value={password}
            />
          </div>
    ...
    <p className="colored-text">{newList.length}</p>
      ...
      <img src="https://assets.ccbp.in/frontend/react-js/password-manager-search-img.png" classsName="input-search" alt="search"/>
      <input type="search" placeholder="Search" onSearch={this.searchList} value={searchInput}/>
      </div>
      </div>
      <hr/>
      ...
      {isTrue&&(
        ...
        {newList.map(eachValue=>(
          ...
          <button type="button" testid="delete" onClick={()=>this.deleteItem(eachValue.id)}>
